...
public class CountdownFalso : MonoBehaviour
{
    ...
    {
        print("FALSO: initialize todo mal");
    }

    void CountdownEnd()
    {
        print("FALSO: countdown end");
        countdown = 0;
    }

    IEnumerator StayBlack()
    {
        print("FALSO: arranca el stayblack");
        countdown = 0;
